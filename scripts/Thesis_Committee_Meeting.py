...
for digit in [2, 3, 4, 5]:
    ...
    for cp in [
        ...
        if digit == 2:
            ...
            cs1 = CrossSection(cp, 0.1625, rotation=rotation)
            cs2 = CrossSection(cp, 0.2750, rotation=rotation)
            cs3 = CrossSection(cp_round, 0.3875, rotation=rotation)
            cs4 = CrossSection(cp_round, 0.5000, rotation=rotation)
            cs5 = CrossSection(cp_round, 0.6125, rotation=rotation)
            cs6 = CrossSection(cp_round, 0.7250, rotation=rotation)
            cs7 = CrossSection(cp_round, 0.8375, rotation=rotation)
            cs8 = CrossSection(cp_round, 0.9500, rotation=rotation)
            cs_combinations.append([cs0, cs1, cs2, cs3, cs4, cs5, cs6, cs7, cs8])
        elif digit == 3:
            cs0 = CrossSection(cp_round, 0.0500, rotation=rotation)
            cs1 = CrossSection(cp_round, 0.1625, rotation=rotation)
            cs2 = CrossSection(cp, 0.2750, rotation=rotation)
            cs3 = CrossSection(cp, 0.3875, rotation=rotation)
            cs4 = CrossSection(cp, 0.5000, rotation=rotation)
            cs5 = CrossSection(cp_round, 0.6125, rotation=rotation)
            ...
            cs0 = CrossSection(cp_round, 0.0500, rotation=rotation)
            cs1 = CrossSection(cp_round, 0.1625, rotation=rotation)
            cs2 = CrossSection(cp_round, 0.2750, rotation=rotation)
            cs3 = CrossSection(cp_round, 0.3875, rotation=rotation)
            cs4 = CrossSection(cp, 0.5000, rotation=rotation)
            cs5 = CrossSection(cp, 0.6125, rotation=rotation)
            cs6 = CrossSection(cp, 0.7250, rotation=rotation)
