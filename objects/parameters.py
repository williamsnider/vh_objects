...
NUM_ENDPOINTS_SLOPE = (
    2  # Extra controlpoints that determine slope of spline at endpoint
)
NUM_CROSS_SECTION_SLOPE = 2  # Extra controlpoints that determine slope of spline at the cross sections closest to the endpoints
