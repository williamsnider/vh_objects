...
FAIRING_DISTANCE = (
    3  # How far (mm) from a junction should vertices in a union mesh be faired
)

# Interface construction
INTERFACE_PATH = Path("./assets/Interface_0032 v2.stl")
...
INTERFACE_SHIFT = -15  # Length of post
LABEL_DEPTH = 0.5
