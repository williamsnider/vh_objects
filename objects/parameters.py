...
SAMPLING_DENSITY_U = 250  # Number of samples along round axis of 'cylinder' axial component
SAMPLING_DENSITY_V = 250  # Number of samples along long axis of 'cylinder' axial component
...
INTERFACE_PATH = Path("./assets/Interface_0031 v2.stl")
...
LABEL_DEPTH = 1.5
FONT_OFFSET_HEIGHT = 1100
FONT_OFFSET_WIDTH = 800
